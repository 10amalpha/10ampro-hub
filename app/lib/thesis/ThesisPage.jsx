...
const utmFor = (slug, m) => `https://10am.pro?utm_source=${slug}&utm_medium=${m}&utm_campaign=hub`;
...
// ============================================================
export default function ThesisPage({ TOKEN }) {
  const API = `/api/hub/${TOKEN.slug}`; const utm = (m) => utmFor(TOKEN.slug, m);
