...
export const TOKEN = {
  ...
  catalyst: {
    ...
    body: [
      ...
      '<b>Por qué le sirve a JTO.</b> El yield de staking en Solana son dos cosas: SOL impreso + tips MEV — las propinas que pagan los traders por prioridad, o sea, el negocio de Jito. Los propios autores modelan el yield base cayendo de ~5.8% a ~2.2% en tres años. Los tips no dependen de la emisión: cuando lo impreso se achica, el MEV deja de ser el condimento y pasa a ser el plato. Stakear sin Jito rinde cada vez menos; en stakear con Jito, la parte que solo Jito reparte pesa cada vez más.',
